...
lib.set_write_image_line.argtypes = [ctypes.c_void_p, ctypes.c_int]
lib.set_write_image_line.restype = ctypes.c_void_p
...
lib.get_write_image_line.argtypes = [ctypes.c_void_p]
lib.get_write_image_line.restype = ctypes.c_int
