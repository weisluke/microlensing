...
lib.set_y1.argtypes = [ctypes.c_void_p, ctypes.c_double]
lib.set_y1.restype = ctypes.c_void_p
lib.set_y2.argtypes = [ctypes.c_void_p, ctypes.c_double]
lib.set_y2.restype = ctypes.c_void_p
lib.set_v1.argtypes = [ctypes.c_void_p, ctypes.c_double]
lib.set_v1.restype = ctypes.c_void_p
lib.set_v2.argtypes = [ctypes.c_void_p, ctypes.c_double]
lib.set_v2.restype = ctypes.c_void_p
...
lib.set_write_images.argtypes = [ctypes.c_void_p, ctypes.c_int]
lib.set_write_images.restype = ctypes.c_void_p
lib.set_write_image_lines.argtypes = [ctypes.c_void_p, ctypes.c_int]
lib.set_write_image_lines.restype = ctypes.c_void_p
lib.set_write_magnifications.argtypes = [ctypes.c_void_p, ctypes.c_int]
lib.set_write_magnifications.restype = ctypes.c_void_p
...
lib.get_y1.argtypes = [ctypes.c_void_p]
lib.get_y1.restype = ctypes.c_double
lib.get_y2.argtypes = [ctypes.c_void_p]
lib.get_y2.restype = ctypes.c_double
lib.get_v1.argtypes = [ctypes.c_void_p]
lib.get_v1.restype = ctypes.c_double
lib.get_v2.argtypes = [ctypes.c_void_p]
lib.get_v2.restype = ctypes.c_double
...
lib.get_write_images.argtypes = [ctypes.c_void_p]
lib.get_write_images.restype = ctypes.c_int
lib.get_write_image_lines.argtypes = [ctypes.c_void_p]
lib.get_write_image_lines.restype = ctypes.c_int
lib.get_write_magnifications.argtypes = [ctypes.c_void_p]
lib.get_write_magnifications.restype = ctypes.c_int
...
lib.get_images.restype = ctypes.POINTER(ctypes.c_double)
lib.get_num_images.argtypes = [ctypes.c_void_p]
lib.get_num_images.restype = ctypes.c_int
lib.get_images_mags.argtypes = [ctypes.c_void_p]
lib.get_images_mags.restype = ctypes.POINTER(ctypes.c_double)
lib.get_image_lines.argtypes = [ctypes.c_void_p]
lib.get_image_lines.restype = ctypes.POINTER(ctypes.c_double)
lib.get_num_image_lines.argtypes = [ctypes.c_void_p]
lib.get_num_image_lines.restype = ctypes.c_int
lib.get_image_lines_lengths.argtypes = [ctypes.c_void_p]
lib.get_image_lines_lengths.restype = ctypes.POINTER(ctypes.c_int)
lib.get_total_image_lines_length.argtypes = [ctypes.c_void_p]
lib.get_total_image_lines_length.restype = ctypes.c_int
lib.get_source_lines.argtypes = [ctypes.c_void_p]
lib.get_source_lines.restype = ctypes.POINTER(ctypes.c_double)
lib.get_image_lines_mags.argtypes = [ctypes.c_void_p]
lib.get_image_lines_mags.restype = ctypes.POINTER(ctypes.c_double)
